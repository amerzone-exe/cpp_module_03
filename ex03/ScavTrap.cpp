...
/*   Updated: 2026/01/07 17:46:09 by jpiquet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap( std::string name ) : ClapTrap(name), _gateKeep(false)
{
	...
	this->_energyPoint = 50;
	this->_attackDamage = 20;
	std::cout << "ScavTrap initialization's constructor called with the name : " << name << std::endl;
}
...
{
	std::cout << "ScavTrap destructor called with the name : " << this->_name << std::endl;
}
